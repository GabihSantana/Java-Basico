...
public class UrnaView {
	...
	protected void createContents() {
		...
		btnAbertura.setBounds(82, 154, 97, 34);
		...
		btnFechamento.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				// date time pega 1 mês a frente
				dateTimeFechamento.setDay(urna.getDataAbertura().getDayOfMonth());
				dateTimeFechamento.setMonth(urna.getDataAbertura().getMonthValue());
				dateTimeFechamento.setYear(urna.getDataAbertura().getYear());
				
			}
		});
		btnFechamento.setBounds(372, 154, 97, 34);
